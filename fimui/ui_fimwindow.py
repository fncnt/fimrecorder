...
class Ui_fimWindow(object):
    def setupUi(self, fimWindow):
        ...
        self.ExpTimeSlider = QtWidgets.QSlider(self.tabCam)
        self.ExpTimeSlider.setMinimum(1)
        self.ExpTimeSlider.setMaximum(30)
        self.ExpTimeSlider.setOrientation(QtCore.Qt.Horizontal)
        self.ExpTimeSlider.setObjectName("ExpTimeSlider")
        self.gridLayout.addWidget(self.ExpTimeSlider, 0, 1, 1, 1)
        self.ExpTimeSpinBox = QtWidgets.QSpinBox(self.tabCam)
        self.ExpTimeSpinBox.setMinimum(1)
        self.ExpTimeSpinBox.setMaximum(30)
        ...
        self.ExpTimeSlider.sliderMoved['int'].connect(self.ExpTimeSpinBox.setValue)
        self.ExpTimeSpinBox.valueChanged['int'].connect(self.ExpTimeSlider.setValue)
    ...
    def retranslateUi(self, fimWindow):
        ...
        self.ExposureTimeLabel.setText(_translate("fimWindow", "Exposure Time [ms]"))
