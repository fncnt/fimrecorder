...
class Ui_fimWindow(object):
    def setupUi(self, fimWindow):
        ...
        self.FpsEnablChkBx = QtWidgets.QCheckBox(self.tabCam)
        self.FpsEnablChkBx.setObjectName("FpsEnablChkBx")
        self.gridLayout.addWidget(self.FpsEnablChkBx, 2, 0, 1, 1)
        ...
        self.FpsEnablChkBx.toggled['bool'].connect(self.FpsDSpinBox.setEnabled)
    ...
    def retranslateUi(self, fimWindow):
        ...
        self.FpsEnablChkBx.setText(_translate("fimWindow", "Frame rate [fps]"))
