...
class Ui_fimWindow(object):
    def setupUi(self, fimWindow):
        ...
        self.camGL = QtWidgets.QOpenGLWidget(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(4)
        sizePolicy.setVerticalStretch(4)
        sizePolicy.setHeightForWidth(self.camGL.sizePolicy().hasHeightForWidth())
        self.camGL.setSizePolicy(sizePolicy)
        self.camGL.setMinimumSize(QtCore.QSize(360, 360))
        self.camGL.setObjectName("camGL")
        self.gridLayout_2.addWidget(self.camGL, 1, 1, 1, 1)
