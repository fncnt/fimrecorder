...
class Ui_fimWindow(object):
    def setupUi(self, fimWindow):
        ...
        self.gridLayout.addWidget(self.FramesModuloSpinBox, 8, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.FramesModuloLabel, 8, 0, 1, 1)
        ...
        self.BgSubChkBx = QtWidgets.QCheckBox(self.tabCam)
        self.BgSubChkBx.setObjectName("BgSubChkBx")
        self.gridLayout.addWidget(self.BgSubChkBx, 6, 0, 1, 1)
    ...
    def retranslateUi(self, fimWindow):
        ...
        self.BgSubChkBx.setToolTip(_translate("fimWindow", "Apply automatic background substraction to reduce noise of static reflecting featrues such as bubbles, food, or scratches."))
        self.BgSubChkBx.setText(_translate("fimWindow", "Automatic Background Substraction"))
        ...
        self.camWidget.setToolTip(_translate("fimWindow", "This reduces noise induces by static reflecting features such as scratches, air bubbles or food."))
